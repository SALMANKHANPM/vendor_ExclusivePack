...
#nclude $(CLEAR_VARS)
#LOCAL_MODULE := AllInOneCalculator
#LOCAL_MODULE_TAGS := optional
#LOCAL_SRC_FILES := AllInOneCalculator/AllInOneCalculator.apk
#LOCAL_CERTIFICATE := PRESIGNED
#LOCAL_MODULE_CLASS := APPS
#LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
#LOCAL_MODULE_PATH := $(TARGET_OUT)/priv-app
...
#include $(CLEAR_VARS)
#LOCAL_MODULE := Betterbatterystats_xdaedition
#LOCAL_MODULE_TAGS := optional
#LOCAL_SRC_FILES := priv-app/$(LOCAL_MODULE).apk
#LOCAL_CERTIFICATE := PRESIGNED
#LOCAL_MODULE_CLASS := APPS
...
#include $(CLEAR_VARS)
#LOCAL_MODULE := HedgeCam
#LOCAL_MODULE_TAGS := optional
#LOCAL_SRC_FILES := HedgeCam/HedgeCam.apk
#LOCAL_CERTIFICATE := PRESIGNED
#LOCAL_PRIVILEGED_MODULE := true
#LOCAL_MODULE_CLASS := APPS
#LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
...
#LOCAL_MODULE_TAGS := optional
#LOCAL_SRC_FILES := FireFoxLite/FireFoxLite.apk
#LOCAL_CERTIFICATE := PRESIGNED
#LOCAL_MODULE_CLASS := APPS
#LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
#LOCAL_MODULE_PATH := $(TARGET_OUT)/priv-app
